...
urlpatterns = [
    path('index/<slug:slug>/', views.PostIndexView.as_view(query_status='published'), name='index'),
    path('index/draft/<slug:slug>/', views.PostIndexView.as_view(query_status='draft'), name='index-draft'),
    path('index/deleted/<slug:slug>/', views.PostIndexView.as_view(query_status='deleted'), name='index-deleted'),
